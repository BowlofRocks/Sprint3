  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>React Native Countdown Timer</Text>
        <View style={styles.timer}>
          <Text style={[styles.timeUnit, styles.yearUnit]}>
            {formatTime(timeUnits.years)}
          </Text>
          <Text style={styles.timeSeparator}></Text>
          <Text style={[styles.timeUnit, styles.dayUnit]}>
            {formatTime(timeUnits.days)}
          </Text>
          <Text style={styles.timeSeparator}></Text>
          <Text style={[styles.timeUnit, styles.hourUnit]}>
